...
ActiveRecord::Schema.define(version: 20_210_125_210_229) do
  ...
  create_table 'promotions', force: :cascade do |t|
    ...
    t.integer 'user_approved_id'
    t.index ['user_approved_id'], name: 'index_promotions_on_user_approved_id'
  ...
  add_foreign_key 'promotions', 'users', column: 'user_approved_id'
end
