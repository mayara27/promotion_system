...
feature 'Admin activate coupon' do
  scenario 'successfully' do
    ...
    click_on 'Ativar cupom'

    expect(page).to have_content('Cupom ativado com sucesso')
    expect(page).to have_content('CARNA10-0001 (disponível)')
    expect(page).to_not have_link('Ativar cupom')
    expect(page).to have_link('Descartar cupom')
